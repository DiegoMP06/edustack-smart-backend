        ...
        <div className="grid gap-2">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Puedes editar el contenido de tu post. Solo haz click en
                        el botón de editar.
                    </CardDescription>
                </CardHeader>
                <CardFooter>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Estado del post</CardTitle>
                    <CardDescription>
                        Tu post puede estar en dos estados: Oculto y Publicado.
                        Los posts ocultos son aquellos que no se muestran en la
                        sección de blog. Los posts publicados son aquellos que
                        se muestran en la sección de blog.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <p>
