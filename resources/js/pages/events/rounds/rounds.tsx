...
import RoundItem from '@/components/events/rounds/RoundItem';
import Pagination from '@/components/ui/app/pagination';
import { Button } from '@/components/ui/shadcn/button';
import AppLayout from '@/layouts/app-layout';
import events from '@/routes/events';
import type { BreadcrumbItem, PaginationType } from '@/types';
import type { Event, EventActivity, CompetitionRound } from '@/types/events';

type RoundsProps = {
    event: Event;
    activity: EventActivity;
    rounds: PaginationType<CompetitionRound>;
};
