        ...
        <div className="grid gap-2">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Puedes editar el contenido de tu proyecto. Solo haz
                ...
                <CardFooter>
                    <Button
                        ...
                        onClick={() =>
                            router.visit(
                                projects.content.edit(projectId, {
                                    query: { edit: true },
                                }),
                            )
                        }
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Puedes gestionar los colaboradores de tu proyecto. Solo
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Tu proyecto puede estar en dos estados: Oculto y
                        Publicado. Los proyectos ocultos son aquellos que no se
                        muestran en la sección de proyectos. Los proyectos
