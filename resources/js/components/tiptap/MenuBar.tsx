...
export default function MenuBar({ editor }: MenuBarProps) {
    ...
    if (!editor || !config) {
        return (
            <div className="h-11 animate-pulse rounded-t border-b border-neutral-200 bg-neutral-50 p-2" />
        );
    }

    return (
        <div className="rounded-t border-b border-neutral-200 bg-neutral-50 select-none">
            ...
            <div className="flex items-center gap-3 border-t border-neutral-100 px-2 pb-1.5 text-xs text-indigo-700">
                <span>
