                        ...
                        <div className="flex max-w-35 flex-wrap gap-2">
                            {TEXT_COLORS.map((c) => (
                                <button
                                    ...
                                    className="flex size-6 items-center justify-center rounded border border-border transition-transform hover:scale-110 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none"
                                    style={{
