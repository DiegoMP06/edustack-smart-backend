...
#[TypeScript]
class EventActivityRegistrationData extends UserData
{
    public function __construct(
        ...
        public int $pivot_id,
        public ActivityRegistrationStatus $pivot_status,
    ...
    public static function fromModelWithPivot(User $user): self
    {
        return new self(
            ...
            pivot_status: ActivityRegistrationStatus::from($user->pivot->status),
