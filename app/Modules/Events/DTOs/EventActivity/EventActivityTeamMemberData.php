...
#[TypeScript]
class EventActivityTeamMemberData extends UserData
{
    public function __construct(
        ...
        public int $pivot_id,
        public TeamMemberRole $pivot_role,
        #[TypeScriptType('string|null')]
        public ?DateTimeInterface $pivot_joined_at,
    ) {
        parent::__construct(
            $id,
            $name,
    ...
    public static function fromModelWithPivot(User $user): self
    {
        return new self(
            ...
            pivot_role: TeamMemberRole::from($user->pivot->role),
            pivot_joined_at: $user->pivot->joined_at,
        );
    }
}
