...
use App\Enums\Forms\LogicActionType;
use App\Enums\Logic\ConditionalOperator;
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('form_logic_rules', function (Blueprint $table) {
            ...
            $table->enum('action_type', LogicActionType::cases());
            $table->enum('condition_operator', ConditionalOperator::cases())->default(ConditionalOperator::AND_OPERATOR);
